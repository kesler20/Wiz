...
out = html.Div(
    dbc.Row(
        [
            html.H6([],id = 'main-min-size', style= dict(display = 'inline-block')),
            html.Div(scale, id = 'main-size-scale', style= dict(display = 'inline-block', width = '50%')),
            html.H6([],id = 'main-max-size', style= dict(display = 'inline-block')),
        ],
    align = 'center',
    justify = 'center'
    ),
    id = 'main-display-size-scale',

...
out = html.Div(
    dbc.Row(
        [
            html.H6([],id = 'example-4-min-size', style= dict(display = 'inline-block')),
            html.Div(scale, id = 'example-4-size-scale', style= dict(display = 'inline-block', width = '50%')),
            html.H6([],id = 'example-4-max-size', style= dict(display = 'inline-block')),
        ],
    align = 'center',
    justify = 'center'
    ),
    id = 'example-4-display-size-scale',
